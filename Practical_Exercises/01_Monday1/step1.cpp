...
typedef MyClass1 MyClass;

// Every attempt to copy and move instances of MyClass are failing, as
// the private (and not implemented) copy constructor and assignments
// also prevents move constructor and assignment. (If the declarations
// were not private, an error would occur at link-time, as there is
// no implementation.)
